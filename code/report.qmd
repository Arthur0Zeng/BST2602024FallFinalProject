...
This study offers a comprehensive analysis of COVID-19 trends but has notable limitations. First, missing CDC data from early 2020, particularly in major states, introduced extreme outliers, complicating accurate estimates of excess mortality. Second, in later stages, underreporting weakened the observed relationship between COVID-19 mortality and excess mortality, as fewer cases were recognized or reported. The regression model explained strong overall relationships, though deviations at Q-Q plot tails indicate challenges with extreme values in outlier states.
